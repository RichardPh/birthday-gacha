        ...
        <AnimatePresence>
          {prize && (
            ...
            >
              ...
              {!confirmed ? (
                <button onClick={handleConfirmClick} className="ml-3 sm:ml-4 px-3 sm:px-4 py-0.5 sm:py-1 bg-amber-500 hover:bg-amber-600 text-white rounded transition text-base sm:text-lg">Velg</button>
              ) : (
